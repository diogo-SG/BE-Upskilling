...
//   const { rows } = await dataSource.query(query, [name, email, password, username]);
//   return rows[0];
// }
...
//   const { rows } = await dataSource.query(query, [email]);
//   return rows[0];
// }
...
//   const { rows } = await dataSource.query(query, [name, email, password, username, id]);
//   return rows[0];
// }
...
//   await dataSource.query(query, [id]);
...
//   const { rows } = await dataSource.query(query, [userId, orderId]);
//   return rows[0];
// }
